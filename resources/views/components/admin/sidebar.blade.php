...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">WEBEESOCIAL CA</span>
        <!-- <img src="{{ asset('admin/img/avatars/logoo.jpeg') }}" width="100px" class="img-fluid" alt="logo"> -->
      </a>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="" class="menu-link">
              <div data-i18n="Without menu">Our service List</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="" class="menu-link">
